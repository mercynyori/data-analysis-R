...
My hypothesis were the following:
           ...
           H₀: There is no relationship between weekly study hours and the final grades of the students. 
...
Future Improvements:
        ...
        Using the learning behaviors to create models that can predict the student's exam grades to determine which behaviors lead to better exam scores. 
